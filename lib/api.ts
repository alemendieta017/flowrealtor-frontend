...
export const propertiesApi = {
  list: (agentId: string, params?: PaginationParams) =>
    request<PaginatedResponse<Property>>(`/properties${toQueryString({ agentId, ...params })}`),
  ...
  getImages: (id: string) => request<PropertyImage[]>(`/properties/${id}/images`),
...
export const contentApi = {
  ...
  get: (propertyId: string) => request<PropertyContent>(`/content/${propertyId}`),
...
export const listingsApi = {
  ...
  getStatus: (propertyId: string) => request<ListingStatus>(`/listings/${propertyId}/status`),
};

// ---- BRIEFS ----
export const briefsApi = {
  list: (agentId: string, params?: PaginationParams) =>
    request<PaginatedResponse<Brief>>(`/briefs${toQueryString({ agentId, ...params })}`),
  generate: (
    propertyId: string,
    config?: {
      template?: string;
...
export const socialApi = {
  list: (agentId: string, params?: PaginationParams) =>
    request<PaginatedResponse<SocialPost>>(`/social${toQueryString({ agentId, ...params })}`),
  generate: (
    propertyId: string,
    config?: {
      platform?: string;
  ...
  getPosts: (propertyId: string) => request<SocialPost[]>(`/social/${propertyId}/posts`),
};

// ---- VIDEO ----
export const videosApi = {
  list: (agentId: string, params?: PaginationParams) =>
    request<PaginatedResponse<Video>>(`/videos${toQueryString({ agentId, ...params })}`),
  generate: (
    propertyId: string,
    config?: {
      format?: string;
